...
contract NFTMarket is ReentrancyGuard {
  ...
  /* Changes the listing price of the contract */
  function changeListingPrice(uint256 price) public onlyOwner {
    listingPrice = price;
  }
  ...
  function unlistMarketItem(address nftContract, uint256 itemId) public nonReentrant {
